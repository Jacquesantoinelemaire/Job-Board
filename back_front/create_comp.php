    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div
          ...
          <div class="flex flex-col justify-center p-8 md:p-14">
            ...
            <form action="test_create_comp.php" method="POST">

            <div class="grid grid-cols-2 gap-5">
              <input type="text" name="comp_name" placeholder="Nom de l'entreprise" class="border border-gray-400 py-1 px-2">
              <input type="text" name="adress" placeholder="adresse" class="border border-gray-400 py-1 px-2">
            </div>
