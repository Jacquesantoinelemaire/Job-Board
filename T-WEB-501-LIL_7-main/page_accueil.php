...
<body class="bg-gradient-to-r from-purple-500 via-pink-300 to-purple-200">
    ...
    <div class="container mx-auto flex items-center justify-between px-4">
      ...
      <div class="flex flex-wrap">
        <a href="connexion.php" class="text-white m-2 px-4 py-2 rounded-md bg-blue-500 hover:bg-blue-600">Connexion</a>
        <a href="inscription.php" class="text-white m-2 px-4 py-2 rounded-md bg-green-500 hover:bg-green-600">Inscription</a>
      </div>
    </div>
  </header>
