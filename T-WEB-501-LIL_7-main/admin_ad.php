...
<body class="bg-gradient-to-r from-purple-500 via-pink-300 to-purple-200">
  ...
  <form action='test_admin_modif.php' method='POST'>
    <a href="admin.php" class='boutonPost bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded'>Retour</a>
  <button class='boutonPost bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded' type='submit' name='action' value='create'> Créer une nouvelle annonce</button>
  </form> <br>

<?php
readAdvertisementsForUpdateAdmin() ?>
